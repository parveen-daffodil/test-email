...
*SaaS Agreement - 15:05*

**Provider** means Parveen (Daffodil) of GGN, contactable on parveen.lukha@daffodilsw.com`Parve signed for Parveen on Fri, 07 Jul 2017 09:42:35 GMT`



**Customer** means Test (Daffodil) of GGN, contactable on test@daffodilsw.com`Test not required to sign`
...
- Customer authorises Provider to effect payment of invoices via direct debit, credit card or any other method directed by Provider every week.
...
- charge Customer interest at an interest rate equal to the [ATO GIC Rate](https://www.ato.gov.au/Rates/General-interest-charge-%28GIC%29-rates/); and
- suspend the provision of any part of the Services to Customer.

## Setup

Provider is responsible for the setup and installation of the Services.
...
- Customer provides a revocable, non-transferable and unsublicensable Expansive Licence over the Data to Provider for any purpose whatsoever.
...
Provider may cancel the Agreement without giving reasons with 14 days of written notice.  Customer agrees that this is reasonable given the number of agreements of a similar nature that Provider has with other parties.
...
- Defined words and phrases are capitalised and hyperlinked.
- Clauses with defined phrases will be read in such a way that the rights and obligations described by the defined phrase are incorporated by reference into the clause.
