...
*Simple Services Agreement - 16:27*

**Provider** means Parveen (Daffodil) of GGN, contactable on parveen.lukha@daffodilsw.com

**Provider** means Parveen (Daffodil) of GGN, contactable on parveen.lukha@daffodilsw.com

`parveen signed for Parveen on Thu, 12 Jan 2017 11:02:57 GMT`

**Customer** means Parv (Daffodil123) of GGN, contactable on ramesh.bansal@daffodilsw.com

**Customer** means Parv (Daffodil123) of GGN, contactable on ramesh.bansal@daffodilsw.com

`Parv signed for Parv on Thu, 12 Jan 2017 11:09:34 GMT`
...
- If, at Customer's request, Provider provides additional services outside the scope of the Services then Customer must pay Provider a rate of $11 per hour (including GST) for the extra work.
...
means means the document agreed between the parties setting out the scope of work to be delivered by Provider to  Customer, titled  <i>tets</i> version test.
